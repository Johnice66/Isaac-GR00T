...
def modality_keys(modality_config: Dict[str, Any], section: str) -> set:
    ...
    if isinstance(section_config, dict):
        return set(section_config.get("modality_keys", []))
    return set(getattr(section_config, "modality_keys", []) or [])
...
class RobotNode(Node):
    ...
    def get_obs(self) -> Optional[Dict[str, Any]]:
        ...
        language = {"annotation.human.task_description": [[self.config.task]]}
